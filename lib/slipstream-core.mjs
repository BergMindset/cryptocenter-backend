...
/** K9: подтвердить, что позиция принадлежит owner, и взять ЖИВУЮ ликвидность из чейна
 *  (не из запроса клиента). Без этого бэкенд был бы фабрикой «настоящего» calldata для фишинга. */

...
import { baseClient, verifyPool, assertStablePair, buildEnterPlan, buildExitTxs, describePlan, poolTick, listPositions, verifyPosition, DEFAULTS, CORRIDORS, AERODROME } from './slipstream-core.mjs'
...
export default async function poolsRoutes(app) {
  ...
  app.post('/api/pools/exit-plan', async (req, reply) => {
    ...
    try {
      ...
      const txs = buildExitTxs(pos.tokenId, pos.liquidity, wallet)
